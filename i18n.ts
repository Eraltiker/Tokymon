...
export const translations = {
  ...
  de: {
    ...
    tip_hint: "Differenz = Trinkgeld",
    system_verified: "Vom System verifiziert",
    ai_strategy_sub: "Strategie & Prognose",
    wallet_master: "Hauptkasse Tokymon",
    bank_digital: "Digitales Konto",
    estimated_balance: "Saldo geschätzt",
    current_balance: "Aktueller Saldo",
    opening_balance: "Anfangsbestand",
    handover_in: "Übergabe (+)",
    withdrawal_out: "Entnahme (-)",
    journal_title: "Finanzjournal",
    logic_hint_app: "Tipp: App-Umsätze werden als Bargeld für die Übergabe gezählt.",
    
    filter_min_amount: "Min Betrag",
    filter_max_amount: "Max Betrag",
    filter_status: "Status",
    filter_category: "Kategorie",
    filter_source: "Zahlungsweg",
    status_paid: "Bezahlt",
    status_debt: "Offen",
